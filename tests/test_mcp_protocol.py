...
calls to Groq on every push - a cost/flakiness tradeoff this project doesn't
take on. These tests cover everything the tools themselves promise,
independent of any particular LLM's tool-calling decisions.
"""
