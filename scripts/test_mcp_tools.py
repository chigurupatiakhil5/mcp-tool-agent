...
This isn't the automated test suite (see tests/test_mcp_protocol.py for
that) - it's a quick, human-readable way to see all three tools' schemas
and results at a glance without opening Claude Desktop.
"""
